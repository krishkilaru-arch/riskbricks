...
%pip install -U -qqq mlflow-skinny[databricks]==3.4.0 databricks-langchain==0.8.0 langchain==0.3.7 langchain-community==0.3.7 databricks-agents mlflow[databricks]
