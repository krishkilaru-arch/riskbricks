...
try:
    ...
    dbutils.notebook.run(
        cfg.agent_notebook("05_news_analytics_agent"),
        0,
    ...
    for sym in symbols:
        # 1) Retrieval Agent
        dbutils.notebook.run(
            cfg.agent_notebook("01_retrieval_agent"),
            0,
        ...
        # 2) Forecast Agent
        dbutils.notebook.run(
            cfg.agent_notebook("02_forecast_agent"),
            0,
        ...
        # 3) Risk Agent
        dbutils.notebook.run(
            cfg.agent_notebook("03_risk_agent"),
            0,
            {"symbol": sym, "as_of_date": as_of_date}
        )
    ...
    dbutils.notebook.run(
        cfg.agent_notebook("04_factor_exposure_agent"),
        0,
    ...
    # 4) Decision Agent
    dbutils.notebook.run(
        cfg.agent_notebook("06_decision_agent"),
        0,
        {"as_of_date": as_of_date}
    )
    ...
    dbutils.notebook.run(
        cfg.agent_notebook("07_portfolio_outputs_agent"),
        0,
        {"as_of_date": as_of_date}
    )
    ...
    dbutils.notebook.run(
        cfg.agent_notebook("99_evaluation_agent"),
        0,
